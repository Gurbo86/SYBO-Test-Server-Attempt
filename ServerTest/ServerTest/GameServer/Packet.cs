...
namespace GameServer.Packets
{
    ...
    public class Packet : IDisposable
    {
        ...
        {
            if (OnPacketClosure != null)
            {
                buffer.InsertRange(0, OnPacketClosure());
            }

            // Inserts a timestamp of the delivery time in milliseconds
            // buffer.InsertRange(0, BitConverter.GetBytes((DateTime.UtcNow - new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)).TotalMilliseconds));
            // Inserts the message length at the begining
